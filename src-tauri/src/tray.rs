...
fn get_tray_labels(lang: &str) -> TrayLabels {
    match lang {
        ...
        "it" => TrayLabels {
            ...
            history: "Cronologia",
            account: "Account",
            about: "Informazioni su MyTypeless",
            quit: "Esci",
        },
        _ => TrayLabels {
